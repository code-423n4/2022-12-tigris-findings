...
The first for loop on [lines 70 - 72](https://github.com/code-423n4/2022-12-tigris/blob/main/contracts/Referrals.sol#L70-L72) could have users' generated codes assigned to different address(es) whereas the second for loop on [lines 73 - 75](https://github.com/code-423n4/2022-12-tigris/blob/main/contracts/Referrals.sol#L73-L75) could have all referred traders assigned to different referral code(s).

Additionally, the associated state bool, `isInit` on [line 9](https://github.com/code-423n4/2022-12-tigris/blob/main/contracts/Referrals.sol#L9) could also be removed from the contract. 